...
public class  NewStoryAdapter extends RecyclerView.Adapter<NewStoryAdapter.StoryViewHolder> {
    private List<Story> storiesList;
    private Context context;

    public NewStoryAdapter(ArrayList<Story> storiesList, Context context) {
    ...
    public StoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.new_story_item,parent,false);
