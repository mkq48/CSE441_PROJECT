...
public class ViewStoryAdapter extends RecyclerView.Adapter<ViewStoryAdapter.StoryViewHolder> {
    ...
    public ViewStoryAdapter(ArrayList<Story> storiesList, Context context) {
    ...
    public StoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_story_item,parent,false);
    ...
    public void onBindViewHolder(@NonNull StoryViewHolder holder, int position) {
        ...
        holder.tv_view.setText(String.valueOf(storiesList.get(holder.getAdapterPosition()).getViews()));
...
//                intent.putExtra("favorites",storiesList.get(position).getFavorites());
    ...
    static class StoryViewHolder extends RecyclerView.ViewHolder{
        private TextView tv_name, tv_view, tv_author;
